...
class Apocalypse(Intro):
   ...
   def level1(self):
       ...
       if intro_choice == 1:
         print(level1)
         print("You turned around and went toward the source of the strange sound and to your suprise you saw a little kid caught clutching a dog.You called out to her but she was busy with the dog\n")
         ...
         if choice1 == 1:
             print("You shout after the figure which seems to pay you no mind,You shout again and still it doesnt pay you heed so you step deeper into the bush and call out")
             ...
             exit()
              ...
              print(level1)
              print("You carefully approach the girl and tap her on the shoulders immediately she spins and points her gun at you")
          ...
          print(level1)
          print("You get into the car and rev it up at full speed \n")
          ...
          if choice1==1:
             ...
             print("2. I was wondering what the hell is happening")
              ...
              print("She sees you inside the house and forces her way into the house")
   ...
   def level2(self):
     ...
     print(level2)
     if choice1==1:
       print("Her: Two days ago there was a festivity in the city an everybody in the county attended. Which is why its weird you are still alive(yh that  event i forgot i had some movies to watch so i didnt attend)\n Well when we were in the heat of it some weirdo threw a fog bomb then people started acting weird")
       ...
       if decision_house==1:
            ...
            print("You:'Okay it lets try to block all entry points  in the house and hope to God that they don't manage to get in'")
            ...
            house=int(input())
            if house==1:
              print("You step out gun in hand and start shooting them ")
      ...
      print(level2)
      print("You see the dog by the woman hurt and torn in the corner, then turn your attention to the gurl sitting across you with a puzzled expression ")
      ...
      if decision_dog==2:
         print("Night approaches and dog gets feral")
         ...
         print("you kill the dog and bury it outside")
   ...
   def level3(self):
     ...
     print(level3)
     if self.dog == 1:
       print("You move towards the opposite side of the forest where you don't hear")
       ...
       if route_1==1:
         print("The night was uneventful/In the morning you left with Alicia in tow to the location ")
         ...
         print("The night was uneventful/In the morning you left with Alicia in tow to find another shelter or at least put enough distance between yourself and the monsters ")
     ...
     if self.fortify == 1:
       print("You wake up in the morning after the fight and find the compound in a state of distress as you see body parts strewn about as a result of the nights fight \n You also find the car totalled")
       ...
       if route2==1:
         print("You tag along with Alicia friends and look for the road leading to the nearest town")
         ...
         exit()
            ...
            print("You:'sorry but we can't take you up on that offer I think we have better chances alone'\n You leave the shoo with more supplies and set out looking for a new place")
     ...
     if self.special_decision==1:
        print("You take the car and drive away from the the house behind you the girl gasps and you see a horde of the monsters moving towards your house so you rev the car and drive faster")
